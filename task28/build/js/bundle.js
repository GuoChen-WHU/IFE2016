...
},{"./shell.console.js":6}],2:[function(require,module,exports){
'use strict';
...
},{"./BUS.js":1,"./adapter.js":2,"./craft.js":4,"./dc.js":5,"./shell.console.js":6}],4:[function(require,module,exports){
'use strict';
...
},{"./BUS.js":1,"./adapter.js":2,"./shell.console.js":6,"./shell.js":7}],5:[function(require,module,exports){
'use strict';
...
exports.init = exports.shell = undefined;
...
var mainHTML = '<div class="shell">' + '<div class="universe">' + '<div class="planet"></div>' + '</div>' + '<div class="panel">' + '<section>' + '<p>动力系统选择：</p>' + '<label class="option">' + '<input type="radio" name="dynSys" value="FORWARD">' + '前进号(速率30px/s, 能耗5%/s)' + '</label>' + '<label class="option">' + '<input type="radio" name="dynSys" value="GALLOP">' + '奔腾号(速率50px/s, 能耗7%/s)' + '</label>' + '<label class="option">' + '<input type="radio" name="dynSys" value="SURPASS">' + '超越号(速率80px/s, 能耗9%/s)' + '</label>' + '</section>' + '<section>' + '<p>能源系统选择：</p>' + '<label class="option">' + '<input type="radio" name="eneSys" value="POWER">' + '劲量型(补充能源速度2%/s)' + '</label>' + '<label class="option">' + '<input type="radio" name="eneSys" value="LIGHT">' + '光能型(补充能源速度3%/s)' + '</label>' + '<label class="option">' + '<input type="radio" name="eneSys" value="FOREVER">' + '永久型(补充能源速度4%/s)' + '</label>' + '</section>' + '<section>' + '<button class="control-button" data-command="create">创建新飞船</button>' + '</section>' + '</div>' + '</div>',
    jqueryMap,
    dynSysChosen,
    eneSysChosen,
    createCraft,
